...
___"filetype"___:"pdf" - is default output format (could be skipped), possible variants are limiting by Aspose.Word type support and resticted to: pdf, docx, html; by code
